...
# # exp_name="mq_rn${reasoning_step}_h1${p_hop}_nmem${n_memory}_em${embed_size}_ep${epochs}_p2"
# # exp_name="nogv_em${embed_size}_mf_ep_${epochs}"
...
#     do
#         exp_name="mq_rn${reasoning_step}_h1${p_hop}_nmem${n_memory}_em${embed_size}_ep${epochs}_tm${time}"
...
do
    ...
    do
        exp_name="db_em16_mf_ep_300"
        # exp_name="noself_mq_rn${reasoning_step}_h1${p_hop}_nmem${n_memory}_em${embed_size}_ep${epochs}_${time}"
