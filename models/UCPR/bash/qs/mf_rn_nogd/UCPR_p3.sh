...
# dbkge_kgfre_ba10241.5_rn4_h12_nmem64_1.0e-04_em32_g_aiu_0_0_6000
# dbkge_kgfre_ba10242.0_rn4_h12_nmem64_1.0e-04_em32_g_aiu_0_0_6000
...
batch_size=32
lr=1.0e-04
exp_name=dbkge_kgfre_ba${batch_size}${lambda_num}_rn${reasoning_step}_h1${p_hop}_nmem${n_memory}_${lr}_em${embed_size}


load_pretrain_model=1

export train_file="train_3.py"
